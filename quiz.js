...
const quizHtmlIntermediate = {
  ...
  questions: [
    ...
    },
    {
      ...
      answers: ["&lt;meta charset='utf-8'&gt;", "&lt;meta encoding='UTF-8'&gt;", "&lt;meta http-equiv='charset' content='UTF-8'&gt;", "&lt;encode&gt;UTF-8&lt;/encode&gt;"],
...
const quizCssIntermediate = {
  ...
  questions: [
    ...
    },
    {
      ...
      answers: ["background: gradient(left, red, blue)", "background: linear-gradient(90deg, red, blue)", "background: horizontal-gradient(red, blue)", "background: linear-gradient(to right, red, blue)"],
    ...
    },
    {
      ...
      answers: ["Tourne l'élément de 50 degrés", "Déplace l'élément de 50px vers la droite", "Déplace l'élément de 50% de sa largeur", "Met à l'échelle à 50%"],
    ...
    },
    {
      ...
      answers: ["@media screen", "&lt;link media='print'&gt;", "@print", "@media print"],
    ...
    },
    {
      ...
      answers: ["mask: circle", "clip-path: circle(50%)", "border-radius: 50%", "shape-outside: circle"],
    ...
    },
    {
      ...
      answers: ["grid: 12 columns", "grid-template-columns: repeat(12, 1fr)", "grid-columns: 12", "grid-template: 12"],
    ...
    },
    {
      ...
      answers: ["Applique une transformation immédiate", "Force le recalcul du layout", "Déclenche un reflow", "Optimise les performances pour les animations"],
    ...
    },
    {
      ...
      answers: ["grid-gap: 20px;", "grid-template-columns: gap(20px);", "column-gap: 20px;", "spacing: 20px;"],
    ...
    },
    {
      ...
      answers: ["margin: auto", "position: center", "center: true", "top: 50%; left: 50%; transform: translate(-50%, -50%)"],
    ...
    },
    {
      ...
      answers: ["@-firefox url()", "@browser (type=firefox-disp)", "Impossible", "@supports (-moz-appearance:none)"],
    ...
    },
    {
      ...
      answers: ["@keyframes fadeIn { from { opacity: 0; } }", "transition: smooth 1s", "opacity-transition: 1s ease-in", "fade-effect: true"],
...
const quizJsBasics = {
  ...
  questions: [
    ...
    },
    {
      ...
      answers: ["for (i = 0; i &lt; 10; i++)", "for (let i &lt; 10; i++)", "for (let i = 0; i &lt; 10)", "for (let i = 0; i &lt; 10; i++)"],
    ...
    },
    {
      ...
      answers: ["Double négation", "Crée une copie de x", "Erreur de syntaxe", "Convertit en booléen"],
      correctAnswer: "Convertit en booléen",
    },
    {
      statement: "Quelle est une différence entre switch et if...else ?",
      answers: ["if...else ne peut comparer que des nombres", "switch ne fonctionne qu'avec des chaînes de caractères", "switch est utile quand il y a plusieurs cas à comparer", "switch est plus performant que if...else dans tous les cas"],
    ...
    },
    {
      ...
      answers: ["let result = (x &gt; 10) ? 'Grand' : 'Petit';", "let result = if (x &gt; 10) then 'Grand' else 'Petit';", "let result = x &gt; 10 : 'Grand' ? 'Petit';", "let result = x ? (x &gt; 10, 'Grand', 'Petit');"],
      correctAnswer: "let result = (x &gt; 10) ? 'Grand' : 'Petit';",
    },
    {
      statement: "Que fait 'use strict' ?",
      answers: ["Désactive les erreurs", "Optimise les performances", "Active le mode strict", "Autorise la casse"],
    ...
    },
    {
      ...
      answers: ["new Date(2023, 0, 1)", "new Day('01-01-2023')", "Date.create('2023-01-01')", "new Date(2023, 1, 1)"],
      correctAnswer: "new Date(2023, 0, 1)",
    },
    {
      statement: "Comment empêcher la modification d'un objet ?",
      answers: ["Object.protect(obj)", "obj.lock()", "Object.freeze(obj)", "const obj"],
    ...
    },
    {
      ...
      answers: ["JSON.toText(obj)", "obj.toJSON()", "JSON.stringify(obj)", "serialize(obj)"],
      correctAnswer: "JSON.stringify(obj)",
    },
    {
      statement: "Quelle méthode vérifie si un tableau contient un élément ?",
      answers: ["includes()", "has()", "find()", "exists()"],
      correctAnswer: "includes()",
    },
    {
      statement: "Quelle méthode fusionne deux objets ?",
      answers: ["Object.assign({}, obj1, obj2)", "Object.merge(obj1, obj2)", "obj1 + obj2", "combine(obj1, obj2)"],
    ...
    },
    {
      ...
      answers: ["Math.floor(Math.random() * 10) + 1", "random(1, 10)", "Math.random(1, 10)", "getRandomNumber(1, 10)"],
    ...
    },
    {
      ...
      answers: ["str.startsWith('mot')", "str.beginsWith('mot')", "str.hasPrefix('mot')", "str.indexOf('mot') === 0"],
    ...
    },
    {
      ...
      answers: ["[...arr1, ...arr2]", "arr1 + arr2", "arr1.join(arr2)", "merge(arr1, arr2)"],
  ...
  questions: [
    {
      ...
      answers: ["Une fonction anonyme", "Une fonction avec accès à son scope parent", "Un callback asynchrone", "Un objet littéral"],
    ...
    },
    {
      ...
      answers: ["Proxy.isProxy(obj)", "Reflect.isProxy(obj)", "Object.isProxy(obj)", "Aucune méthode native"],
      correctAnswer: "Aucune méthode native",
    },
    {
      statement: "Qu'est-ce que le hoisting ?",
      answers: ["Une fonction récursive", "L'optimisation du compilateur", "Un design pattern", "Le déplacement des variables en haut du scope"],
    ...
    },
    {
      ...
      answers: ["Filtre les éléments", "Réduit le tableau à une valeur unique", "Clone le tableau", "Modifie chaque élément"],
      correctAnswer: "Réduit le tableau à une valeur unique",
    },
    {
      statement: "Comment utiliser await ?",
      answers: ["Avec .then()", "Dans une boucle for", "Sans mot-clé particulier", "Dans une fonction async"],
      correctAnswer: "Dans une fonction async",
    },
    {
      statement: "Qu'est-ce que l'event bubbling ?",
      answers: ["La propagation des événements de l'enfant au parent", "Un type d'événement personnalisé", "Une erreur JavaScript", "La propagation des événements du parent à l'enfant"],
    ...
    },
    {
      ...
      answers: ["Object.freeze(obj)", "Object.seal(obj)", "Object.preventExtensions(obj)", "delete obj.prototype"],
    ...
    },
    {
      ...
      answers: ["headers: { 'Cache-Control': 'no-cache' }", "cache: 'reload'", "cache: 'no-store'", "cache: 'force-cache'"],
      correctAnswer: "cache: 'no-store'",
    },
    {
      statement: "Qu'est-ce qu'un IIFE ?",
      answers: ["Un design pattern", "Un module ES6", "Une fonction fléchée", "Une fonction immédiatement invoquée"],
      correctAnswer: "Une fonction immédiatement invoquée",
    },
    {
      statement: "Comment vérifier si une propriété est énumérable ?",
      answers: ["hasOwnProperty()", "Object.keys()", "in operator", "propertyIsEnumerable()"],
    ...
    },
    {
      ...
      answers: ["obj1 == obj2", "JSON.stringify(obj1) === JSON.stringify(obj2)", "obj1 === obj2", "Object.compare(obj1, obj2)"],
    ...
    },
    {
      ...
      answers: ["worker.create()", "new Worker('script.js')", "navigator.worker()", "Thread.start()"],
      correctAnswer: "new Worker('script.js')",
    },
    {
      statement: "Qu'est-ce qu'un WeakMap ?",
      answers: ["Un tableau associatif", "Un Map avec des clés faibles", "Une structure de données immutable", "Un Map non ordonné"],
      correctAnswer: "Un Map avec des clés faibles",
    },
    {
      statement: "Comment gérer les dépendances circulaires ?",
      answers: ["En utilisant require()", "Avec des modules ES6", "C'est impossible", "Avec des design patterns"],
    ...
    },
    {
      ...
      answers: ["array.find(obj)", "array.has(obj)", "array.some(el =&gt; el === obj)", "array.contains(obj)"],
      correctAnswer: "array.some(el =&gt; el === obj)",
    },
    {
      statement: "Qu'est-ce que le Temporal Dead Zone (TDZ) ?",
      answers: ["Une erreur de référence", "Un bug de navigateur", "La période avant la déclaration d'une variable let/const", "Un état du garbage collector"],
    ...
    },
    {
      ...
      answers: ["Clone l'objet", "Supprime les propriétés", "Rend l'objet immuable", "Active le mode strict"],
      correctAnswer: "Rend l'objet immuable",
    },
    {
      statement: "Comment utiliser les modules ES6 dans le navigateur ?",
      answers: ["&lt;script module&gt;", "import.meta", "&lt;script type='module'&gt;", "Node.js uniquement"],
      correctAnswer: "&lt;script type='module'&gt;",
    },
    {
      statement: "Quelle méthode permet de regrouper des éléments d'un tableau par clé ?",
      answers: ["array.regroup()", "array.map()", "array.reduce()", "array.sort()"],
    ...
    },
    {
      ...
      answers: ["fetch.cancel()", "XMLHttpRequest uniquement", "Avec AbortController", "Impossible"],
      correctAnswer: "Avec AbortController",
    },
    {
      statement: "Quelle méthode crée une promesse ?",
      answers: ["Promise.create()", "async function() {}", "new Promise((resolve, reject) =&gt; {})", "fetch()"],
      correctAnswer: "new Promise((resolve, reject) =&gt; {})",
    },
    {
      statement: "Qu'est-ce qu'un generator function ?",
      answers: ["Une fonction asynchrone", "Une fonction récursive", "Une fonction avec yield", "Une IIFE"],
    ...
    },
    {
      ...
      answers: ["En déclarant une variable globale", "Avec une closure mais sans cache", "Avec une classe", "Avec un cache interne utilisant un objet ou Map"],
      correctAnswer: "Avec un cache interne utilisant un objet ou Map",
    },
    {
      statement: "Qu'est-ce que le currying ?",
      answers: ["Une erreur de syntaxe", "Un design pattern de classe", "Une méthode de tableau", "Transformer une fonction à plusieurs arguments en fonctions imbriquées"],
    ...
    },
    {
      ...
      answers: ["new Promise(res =&gt; setTimeout(res, 1000))", "delay(1000).then()", "setTimeout.asPromise(1000)", "Promise.wait(1000)"],
      correctAnswer: "new Promise(res =&gt; setTimeout(res, 1000))",
    },
    {
      statement: "Quel est l'avantage des WeakRef en JavaScript ?",
      answers: ["Ils permettent au garbage collector de récupérer des objets non utilisés", "Ils accélèrent l'accès aux objets", "Ils empêchent les fuites de mémoire", "Ils remplacent complètement WeakMap"],
    ...
    },
    {
      ...
      answers: ["Utiliser les promesses", "Utiliser async/await", "Écrire tout le code en synchrone", "Utiliser un setTimeout() pour chaque callback"],
      correctAnswer: "Utiliser async/await",
    },
    {
      statement: "Qu'est-ce qu'un WeakSet ?",
      answers: ["Un Set avec des références faibles", "Un Set non ordonné", "Un Set immutable", "Un Set à clés uniques"],
    ...
    },
    {
      ...
      answers: ["event.button === 2", "event.which(right)", "event.clickRight === true", "event.isRightClick()"],
      correctAnswer: "event.button === 2",
    },
    {
      statement: "Qu'est-ce que le Event Loop ?",
      answers: ["Le mécanisme de gestion des tâches asynchrones", "Une boucle while(true)", "Un design pattern", "Une fonction récursive"],
      correctAnswer: "Le mécanisme de gestion des tâches asynchrones",
    },
    {
      statement: "Comment annuler un setTimeout en cours d'exécution ?",
      answers: ["clearTimeout(timeoutId)", "timeoutId.cancel()", "stopTimeout(timeoutId)", "setTimeout(null)"],
      correctAnswer: "clearTimeout(timeoutId)",
    },
    {
      statement: "Quelle méthode permet de sérialiser une Date en JSON ?",
      answers: ["JSON.stringify() gère nativement les dates", "Utiliser toISOString() avant", "Impossible", "Utiliser un reviver"],
    ...
    },
    {
      ...
      answers: ["document.querySelectorAll('.maClasse')", "document.getElementsByClassName('maClasse')", "document.querySelector('.maClasse')", "document.getElementById('maClasse')"],
      correctAnswer: "document.querySelectorAll('.maClasse')",
    },
    {
      statement: "Qu'est-ce qu'un tag function ?",
      answers: ["Une fonction qui traite des littéraux de template", "Une fonction fléchée", "Une méthode de débogage", "Une fonction qui génère des identifiants uniques"],
    ...
    },
    {
      ...
      answers: ["Object.prototype.isPrototypeOf()", "Object.isIndependant()", "Object.hasOwnProperty()", "Object.getPrototypeOf() === autreObjet"],
      correctAnswer: "Object.prototype.isPrototypeOf()",
    },
    {
      statement: "Quelle API permet de copier du texte dans le presse-papier ?",
      answers: ["navigator.clipboard.writeText()", "document.copyText()", "window.clipboardCopy()", "copyToClipboard()"],
...
const quizGitGithubBasics = {
  ...
  questions: [
    {
      statement: "Git est ...",
      answers: ["...un système de gestion de bases de données", "...un système de contrôle de version", "...un langage de programmation", "...un outil de déploiement"],
    ...
    },
    {
      ...
      answers: ["Crée un nouveau dépôt", "Duplique un commit", "Envoie une copie de nos fichiers locaux sur gitHub", "Copie un dépôt distant en local"],
    ...
    },
    {
      ...
      answers: ["git save -m 'message'", "git commit -m 'message'", "git message 'message'", "git push 'message'"],
      correctAnswer: "git commit -m 'message'",
    },
    {
      statement: "Que montre 'git status' ?",
      answers: ["L'historique des commits", "L'état des fichiers modifiés/non suivis", "La liste des branches", "Les conflits résolus"],
    ...
    },
    {
      ...
      answers: ["Supprimer des fichiers", "Annuler un commit", "Gérer les dépôts distants", "Modifier l'historique"],
      correctAnswer: "Gérer les dépôts distants",
    },
    {
      statement: "Que fait 'git pull' ?",
      answers: ["Envoie les commits locaux", "Crée une pull request", "Télécharge les modifications du dépôt distant et les fusionne", "Affiche les différences"],
    ...
    },
    {
      ...
      answers: ["La liste des branches", "Les clés SSH configurées", "Les utilisateurs GitHub", "Les différences entre les fichiers modifiés et la dernière version"],
    ...
    },
    {
      ...
      answers: ["Un alias pour le dernier commit", "Un tag système", "Un outil de fusion", "La branche actuellement active"],
      correctAnswer: "La branche actuellement active",
    },
    {
      statement: "Que permet de faire un fork d'un dépôt GitHub ?",
      answers: ["Le supprimer", "Créer une copie personnelle indépendante", "Le dupliquer en local", "Signaler un problème"],
      correctAnswer: "Créer une copie personnelle indépendante",
    },
    {
      statement: "Qu'est-ce qu'une pull request ?",
      answers: ["Une demande de suppression de code", "Une demande de fusion de modifications dans un dépôt", "Un outil de débogage", "Une commande Git"],
    ...
    },
    {
      ...
      answers: ["Une erreur de syntaxe", "Un problème réseau", "Un dépôt corrompu", "Quand Git ne peut pas fusionner des modifications automatiquement"],
    ...
    },
    {
      ...
      answers: ["Supprimer l'historique", "Créer un tag", "Gérer les clés SSH", "Enregistrer des modifications temporairement sans commiter"],
    ...
    },
    {
      ...
      answers: ["Télécharge les modifications mais ne les fusionne pas", "Envoie les commits locaux", "Fusionne toutes les branches", "Supprime les fichiers non suivis"],
    ...
    },
    {
      ...
      answers: ["git undo", "git revert HEAD", "git rollback", "git reset --soft HEAD~1"],
      correctAnswer: "git reset --soft HEAD~1",
    },
    {
      statement: "Que signifie 'origin' dans 'git push origin main' ?",
      answers: ["Le nom par défaut du dépôt distant", "La branche principale", "Un tag Git", "Une commande spéciale"],
      correctAnswer: "Le nom par défaut du dépôt distant",
    },
    {
      statement: "À quoi sert un fichier .gitkeep ?",
      answers: ["À forcer Git à suivre un dossier vide", "À ignorer un fichier spécifique", "À stocker des métadonnées Git", "À définir des permissions pour un dépôt"],
    ...
    },
    {
      ...
      answers: ["git fetch met à jour les références distantes sans fusionner, tandis que git pull récupère et fusionne les modifications", "git fetch télécharge uniquement les commits sans les appliquer, tandis que git pull réécrit l'historique", "git fetch est utilisé pour les branches locales, tandis que git pull ne fonctionne que sur les branches distantes", "git fetch est plus rapide car il met directement à jour la branche actuelle, alors que git pull nécessite un merge manuel"],
    ...
    },
    {
      ...
      answers: ["Les fichiers de configuration contenant des secrets (.env)", "Les fichiers de dépendances comme node_modules/", "Les fichiers de code source du projet", "Les fichiers générés automatiquement (logs, builds, caches)"],
    ...
    },
    {
      ...
      answers: ["Définir des règles de fusion pour des fichiers", "Ignorer des fichiers", "Configurer des alias Git", "Stocker des clés SSH"],
      correctAnswer: "Définir des règles de fusion pour des fichiers",
    },
    {
      statement: "Comment créer un tag annoté pour une version ?",
      answers: ["git tag v1.0", "git tag -a v1.0 -m 'Message'", "git version v1.0", "git release v1.0"],
      correctAnswer: "git tag -a v1.0 -m 'Message'",
    },
    {
      statement: "GitHub Actions est ...",
      answers: ["...un outil de chat", "...un système de CI/CD intégré à GitHub", "...un type de pull request", "...un gestionnaire de branches"],
...
const quizGitGithubIntermediate = {
  ...
  questions: [
    ...
    },
    {
      ...
      answers: ["Diviser un dépôt en sous-modules", "Trouver quel commit a introduit un bug", "Comparer deux branches", "Supprimer l'historique"],
      correctAnswer: "Trouver quel commit a introduit un bug",
    },
    {
      statement: "Quelle commande crée un tag annoté avec un message ?",
      answers: ["git tag v1.0", "git tag -a v1.0 -m 'Release'", "git release v1.0", "git annotate v1.0"],
      correctAnswer: "git tag -a v1.0 -m 'Release'",
    },
    {
      statement: "Que fait 'git worktree' ?",
      answers: ["Nettoyer le dépôt", "Travailler sur plusieurs branches dans des répertoires séparés", "Gérer les conflits", "Synchroniser automatiquement les branches locales avec le dépôt distant"],
    ...
    },
    {
      ...
      answers: ["git branch --log &lt;branche&gt;", "git log &lt;branche&gt;", "git show-branch &lt;branche&gt;", "git history &lt;branche&gt;"],
      correctAnswer: "git log &lt;branche&gt;",
    },
    {
      statement: "Qu'est-ce qu'un submodule Git ?",
      answers: ["Un module externe non versionné", "Un sous-répertoire lié à un autre dépôt Git", "Un type de tag", "Une branche secondaire"],
      correctAnswer: "Un sous-répertoire lié à un autre dépôt Git",
    },
    {
      statement: "omment signer un commit avec GPG en ligne de commande ?",
      answers: ["git gpg-sign 'Message'", "git sign --gpg", "git commit -S -m 'Message'", "Configurer GitHub uniquement"],
      correctAnswer: "git commit -S -m 'Message'",
    },
    {
      statement: "Que fait 'git blame' ?",
      answers: ["Annule un commit", "Gère les conflits", "Affiche les auteurs de chaque ligne d'un fichier", "Supprime les modifications non suivies"],
    ...
    },
    {
      ...
      answers: ["Une alternative à .gitignore", "Un hook personnalisé", "Un fichier pour forcer Git à suivre un dossier vide", "Un tag système"],
    ...
    },
    {
      ...
      answers: ["Ajouter * dans .gitignore", "Utiliser chmod", "git config core.fileMode false", "Impossible"],
      correctAnswer: "git config core.fileMode false",
    },
    {
      statement: "Qu'est-ce qu'un 'stash' non appliqué ?",
      answers: ["Un commit non poussé", "Une branche supprimée", "Des modifications temporaires non commitées", "Un conflit non résolu"],
    ...
    },
    {
      ...
      answers: ["git branch -r", "git remote update", "git fetch --prune", "git ls -branch"],
      correctAnswer: "git fetch --prune",
    },
    {
      statement: "Comment fusionner une branche en résolvant les conflits manuellement ?",
      answers: ["git merge --no-ff", "git mergetool", "git resolve", "git conflict --fix"],
    ...
    },
    {
      ...
      answers: ["Lister les fichiers ignorés", "Gérer les tags", "Afficher l'historique des références (commits, branches, etc.)", "Restaurer automatiquement un commit supprimé"],
    ...
    },
    {
      ...
      answers: ["git tag --commit &lt;commit-hash&gt;", "git mark v1.0 &lt;commit-hash&gt;", "git release &lt;commit-hash&gt;", "git tag v1.0 &lt;commit-hash&gt;"],
      correctAnswer: "git tag v1.0 &lt;commit-hash&gt;",
    },
    {
      statement: "Que fait 'git stash pop' ?",
      answers: ["Affiche la liste des stashes", "Crée un nouveau stash", "Annule le dernier commit", "Applique et supprime le dernier stash"],
      correctAnswer: "Applique et supprime le dernier stash",
    },
    {
      statement: "Comment empêcher Git de suivre un fichier déjà versionné ?",
      answers: ["Ajouter le fichier à .gitignore", "git untrack &lt;fichier&gt;", "git remove-tracking &lt;fichier&gt;", "git rm --cached &lt;fichier&gt;"],
      correctAnswer: "git rm --cached &lt;fichier&gt;",
    },
    {
      statement: "Qu'est-ce qu'un 'hook' pre-commit ?",
      answers: ["Un outil de fusion", "Un type de branche", "Un fichier de configuration Git", "Un script exécuté avant chaque commit"],
    ...
    },
    {
      ...
      answers: ["git log --stat &lt;commit1&gt; &lt;commit2&gt;", "git show --files &lt;commit1&gt; &lt;commit2&gt;", "git list-changes &lt;commit1&gt; &lt;commit2&gt;", "git diff --name-only &lt;commit1&gt; &lt;commit2&gt;"],
      correctAnswer: "git diff --name-only &lt;commit1&gt; &lt;commit2&gt;",
    },
    {
      statement: "Comment supprimer une branche distante ?",
      answers: ["git branch -d origin/&lt;branche&gt;", "git remote remove &lt;branche&gt;", "git delete &lt;branche&gt;", "git push origin --delete &lt;branche&gt;"],
      correctAnswer: "git push origin --delete &lt;branche&gt;",
    },
    {
      statement: "Quelle commande convertit un dépôt en bare repository ?",
      answers: ["git bare-init", "git convert --bare", "git init --bare", "git config --bool core.bare true"],
    ...
    },
    {
      ...
      answers: ["git alias --list", "git list-aliases", "git help aliases", "git config --get-regexp alias"],
    ...
    },
    {
      ...
      answers: ["git branch --list", "git merge --check", "git check-merged", "git branch --merged"],
      correctAnswer: "git branch --merged",
    },
    {
      statement: "Quelle commande affiche les contributions de chaque auteur dans un projet Git ?",
      answers: ["git shortlog -s -n", "git log --stat", "git blame --all", "git history --authors"],
      correctAnswer: "git shortlog -s -n",
    },
    {
      statement: "Quelle commande permet de comparer deux branches ?",
      answers: ["git diff &lt;branche1&gt; &lt;branche2&gt;", "git compare &lt;branche1&gt; &lt;branche2&gt;", "git branch --diff &lt;branche1&gt; &lt;branche2&gt;", "git log --compare &lt;branche1&gt; &lt;branche2&gt;"],
      correctAnswer: "git diff &lt;branche1&gt; &lt;branche2&gt;",
    },
    {
      statement: "Comment renommer une branche locale ?",
      answers: ["git branch -m &lt;ancien-nom&gt; &lt;nouveau-nom&gt;", "git rename-branch &lt;ancien-nom&gt; &lt;nouveau-nom&gt;", "git branch --rename &lt;ancien-nom&gt; &lt;nouveau-nom&gt;", "git move-branch &lt;ancien-nom&gt; &lt;nouveau-nom&gt;"],
    ...
    },
    {
      ...
      answers: ["git checkout HEAD -- &lt;fichier&gt;", "git restore &lt;fichier&gt;", "git reset --soft &lt;fichier&gt;", "git revert &lt;fichier&gt;"],
    ...
    },
    {
      ...
      answers: ["git diff --cached", "git log -p", "git status --diff", "git compare --staged"],
      correctAnswer: "git diff --cached",
    },
    {
      statement: "Comment définir un alias Git globalement ?",
      answers: ["git config --global alias.&lt;nom&gt; '&lt;commande&gt;'", "git alias --global &lt;nom&gt; '&lt;commande&gt;'", "git set-alias &lt;nom&gt; '&lt;commande&gt;'", "git shortcut &lt;nom&gt; '&lt;commande&gt;'"],
    ...
    },
    {
      ...
      answers: ["Vérifie l'intégrité de la base de données Git", "Optimise le dépôt Git", "Nettoie les fichiers inutilisés", "Synchronise les branches"],
    ...
    },
    {
      ...
      answers: ["git init", "git reinit", "git reset --init", "git config --init"],
      correctAnswer: "git init",
    },
    {
      statement: "Comment afficher l'historique d'un fichier spécifique, même s'il a été renommé ?",
      answers: ["git log --follow &lt;fichier&gt;", "git history &lt;fichier&gt;", "git track &lt;fichier&gt;", "git log --renamed &lt;fichier&gt;"],
      correctAnswer: "git log --follow &lt;fichier&gt;",
    },
    {
      statement: "Quelle commande supprime définitivement un commit de l'historique ?",
      answers: ["git rebase -i", "git reset --hard HEAD~1", "git filter-branch --force", "git delete-commit"],
      correctAnswer: "git filter-branch --force",
    },
    {
      statement: "Comment créer une nouvelle branche et y basculer en une seule commande ?",
      answers: ["git checkout -b &lt;branche&gt;", "git switch --create &lt;branche&gt;", "git branch -n &lt;branche&gt;", "git create-branch &lt;branche&gt;"],
    ...
    },
    {
      ...
      answers: ["git show --name-only &lt;commit&gt;", "git diff-tree --name-only &lt;commit&gt;", "git log --files &lt;commit&gt;", "git commit --list-files &lt;commit&gt;"],
      correctAnswer: "git show --name-only &lt;commit&gt;",
    },
    {
      statement: "Que fait 'git gc' ?",
      answers: ["Optimise la base de données Git", "Supprime les branches non utilisées", "Gère les commits en attente", "Fusionne les commits en double"],
      correctAnswer: "Optimise la base de données Git",
    },
    {
      statement: "Comment afficher les fichiers non suivis par Git ?",
      answers: ["git status --untracked", "git ls-files --others --exclude-standard", "git show-untracked", "git diff --untracked"],
